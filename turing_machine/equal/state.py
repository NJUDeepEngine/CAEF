...
if __name__ == '__main__':
    generator = EqualTMStateGenerator()
    generator.separator = ''
    # q0 test
    q0_str = 'EQUAL, q0, [HEAD1] 1234[HEAD2] 1234 [OUTPUT]'
    op1 = 1234
    op2 = 1234
    ...
    # q1 test
    q1_str = 'EQUAL, q1,  12[HEAD1]34 12[HEAD2]34 [OUTPUT]True'
    op1 = 1234
    op2 = 1234
    head1_pos = 2
    head2_pos = 2
    ...
    # qH test
    qH_str = 'EQUAL, qH,  1234[HEAD1] 1234[HEAD2] True'
    op1 = 1234
    op2 = 1234
    output = True
