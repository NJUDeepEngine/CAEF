...
class GreaterThanTMStateGenerator:
    def __init__(self):
        self.q0_token = 'q0'
        self.q1_token = 'q1'
        self.qH_token = 'qH'
...
if __name__ == '__main__':
    generator = GreaterThanTMStateGenerator()
    generator.separator = ''
    # q0 test
    q0_str = 'GREATER_THAN, q0, [HEAD1] 1234[HEAD2] 1234 [OUTPUT]'
    op1 = 1234
    op2 = 1234
    ...
    # q1 test
    q1_str = 'GREATER_THAN, q1,  12[HEAD1]34 12[HEAD2]34 [OUTPUT]False'
    op1 = 1234
    op2 = 1234
    head1_pos = 2
    head2_pos = 2
    ...
    # qH test
    qH_str = 'GREATER_THAN, qH,  1234[HEAD1] 1234[HEAD2] False'
    op1 = 1234
    op2 = 1234
    output = False
