class TMCallCommandGenerator:
    def __init__(self):
        ...
        self.less_than_q0_template = '{cmd_token} {h1_token} {right_token}, {h2_token} {right_token}, {output_token} {false_token}, {q1_token}'
        self.add_q0_template = '{cmd_token}: {c_token} 0, {h1_token} {right_token}, {h2_token} {right_token}, {q1_token}'

    def get_q1_cmd(self):
        return self.less_than_q0_template.format(cmd_token=self.cmd_token,
