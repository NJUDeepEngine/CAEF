class TMInputGenerator:
    def __init__(self):
        ...
        self.less_than_halt_template = '{operator}, {qH_token},  {l_op1}{h1_token}{r_op1} {l_op2}{h2_token}{r_op2} {output}'
    ...
    def get_q1_input(self, op1, op2, output):
        ...
        return self.less_than_halt_template.format(operator=self.less_than_token,
