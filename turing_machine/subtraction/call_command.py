class TMCallCommandGenerator:
    def __init__(self):
        ...
        self.reflection_q0_template = '{cmd_token} {h1_token} {right_token}, {h2_token} {right_token}, {q1_token}'
        self.add_q0_template = '{cmd_token}: {c_token} 0, {h1_token} {right_token}, {h2_token} {right_token}, {q1_token}'
        self.left_mask_q0_template = '{cmd_token} {h_token} {right_token}, {q1_token}'


    def get_q1_cmd(self):
        return self.reflection_q0_template.format(cmd_token=self.cmd_token,
    ...
    def get_q4_cmd(self):
        return self.left_mask_q0_template.format(cmd_token=self.cmd_token,
